...
The Juno JIRAM data is stored on the Planetary Data System (PDS), and data from the Juno perijoves (closest approach) can be downloaded from [here](https://pds-atmospheres.nmsu.edu/PDS/data/), with the calibrated JIRAM data directories having a prefix of `jnojir_2*`.
